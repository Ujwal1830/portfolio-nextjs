...
import { SiNextdotjs, SiTypescript, SiTailwindcss, SiMongodb, SiOpenai, SiVite, SiReact, SiAppwrite } from 'react-icons/si';
...
const Projects = () => {
  ...
  const projects: IProject[] = [
    {
      title: 'React 19 Movie App',
      description: 'A modern movie discovery app using React 19 features like use(), Suspense, and Server Components. Integrated with TMDB API and Appwrite for data management.',
      link: 'https://hatela-movie.vercel.app/', // ⬅️ replace with actual link if different
      code: 'https://github.com/Ujwal1830/react-19-movie-app', // ⬅️ replace with your repo link
      image: '/images/react-19-movie-app.png', // ⬅️ make sure this image exists in public/images/
      technologies: [
        { skill: 'React 19', icon: <SiReact className="text-zinc-600 dark:text-zinc-300" /> },
        { skill: 'Vite', icon: <SiVite className="text-purple-500 dark:text-purple-300" /> },
        { skill: 'Tailwind', icon: <SiTailwindcss className="text-blue-400 dark:text-blue-300" /> },
        { skill: 'TMDB API', icon: <MdWebAsset className="text-red-500 dark:text-red-300" /> },
        { skill: 'Appwrite', icon: <SiAppwrite className="text-pink-500 dark:text-pink-300" /> }
      ],
    },    
    {
      title: 'Discover Maps',
